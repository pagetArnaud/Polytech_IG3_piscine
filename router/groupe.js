...
router.get('/', function (req, res) {
    buildFile(req, res, path.join(__dirname, "../vue/groupe/consultation_de_groupe.html"));

});
// About page route.
router.get('/cree', function (req, res) {
    buildFile(req, res, path.join(__dirname, "../vue/groupe/creation_groupe.html"));

});

// About page route.
router.get('/alter', function (req, res) {
    buildFile(req, res, path.join(__dirname, "../vue/groupe/modification_de_groupe.html"));
